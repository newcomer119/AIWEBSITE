...
export const Hero = () => {
  return (
    <section
      className="min-h-screen flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,black,transparent,black_10%,black_90%,transparent)]"
      style={{ backgroundImage: `url(${starsBg.src})` }}
    >
      <div className="absolute inset-0 bg-[radial-gradient(75%_75%_at_center_center,rgb(140,69,255,.5)_15%,rgb(14,0,36,.5)_78%,transparent)]"></div>
      {/* Start Panel */}
      <div className="absolute md:h-96  md:w-96 h-64 w-64 rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_16.8%_18.3%,white,rgb(184,148,255)_37.7%,rgb(24,0,66))] shadow-[0_0_50px_rgb(140,69,255)] drop-shadow-2xl"></div>
      {/* End Panel */}
      {/* Start Ring 1 */}
