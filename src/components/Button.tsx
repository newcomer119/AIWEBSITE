...
export const Button = ({ className = "", children, ...props }: ButtonProps) => {
  return (
    <button 
      className={`relative py-2 px-4 rounded-lg font-medium text-sm text-white bg-gradient-to-b from-[#190d2e] to-[#4a208a] hover:from-[#1a0e30] hover:to-[#4e228f] transition-all duration-200 ${className}`}
      {...props}
    >
